...
const DriverDashboardTabs = memo(({ tabs, activeTab, onTabChange }) => {
  return (
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                {tab.badge && tab.badge > 0 && (
                  <span className="bg-teal-100 text-teal-600 text-xs rounded-full px-2 py-1 min-w-[20px] text-center">
                    {tab.badge}
                  </span>
                )}
              </div>
...
DriverDashboardTabs.displayName = "DriverDashboardTabs";
